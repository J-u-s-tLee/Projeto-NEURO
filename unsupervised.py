...
umap_reduction.plot_embedding(filtered_embedding, labels=filtered_labels, save_path='supervised_output/dbscan.png')
...
silhouette.silhouette_plot(filtered_embedding, kmeans_labels, n_clusters=3, save_path='supervised_output/silhouette_plot_kmeans.png')
silhouette.silhouette_plot(filtered_embedding, filtered_labels, n_clusters=3, save_path='supervised_output/silhouette_plot_dbscan.png')
...
labelling.ordering(filtered_data, labels=filtered_labels, start_time=20, end_time=200, feature_index=8, save_path='supervised_output/labelling_ratio_d_t_f.png')
labelling.ordering(filtered_data, labels=filtered_labels, start_time=20, end_time=200, feature_index=9, save_path='supervised_output/labelling_ratio_d_t_p.png')
labelling.ordering(filtered_data, labels=filtered_labels, start_time=20, end_time=200, feature_index=13, save_path='supervised_output/labelling_mean_magnitude.png')
